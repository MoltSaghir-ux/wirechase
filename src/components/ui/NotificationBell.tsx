  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {count > 0 && (
          <span className={`absolute -top-0.5 -right-0.5 text-[10px] font-bold text-white w-4 h-4 rounded-full flex items-center justify-center ${high > 0 ? 'bg-red-500' : 'bg-blue-500'}`}>
            {count > 9 ? '9+' : count}
          </span>
        )}
      </button>
